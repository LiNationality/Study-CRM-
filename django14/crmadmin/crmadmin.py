...
class BaseAdmin(object):
    ...
    def delete_selected_objs(self, request, querysets):
        ...
        return render(request, "crmadmin/table_obj_delete.html", {"objs": querysets,
                                                                    "admin_class": self,
                                                                    "app_name": app_name,
...
register(models.CustomersFollowUp,CustomerFollowUpAdmin)
register(models.UserProfiles,UserProfileAdmin)
register(models.CoursesRecord,CourseRecordAdmin)
